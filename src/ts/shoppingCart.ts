...
class ShoppingCart {
    ...
    private JiaBtnBindingEvent() {
        ...
        function commonJiaAndJianEvent(index: number, status: boolean) {
            ...
            /*请求修改数量*/
            // @ts-ignore
            window.page.mobileAddReduce(currentGoodsInfo);
        }
    }
    ...
    private deleteBtnClick() {
        ...
        $("#footer .deleteGoods").on("click", function () {
            ...
            //请求删除
            // @ts-ignore
            delShopCart.length && window.page.mDeleteGoods.call(this, delShopCart);
    ...
    /*立即购买按钮的点击事件*/
    private promptlyPurchase(){
        let _this = this;
        $("#footer .liJiGouMai").on('click', function () {
            //请求购买
            // @ts-ignore
            _this.selectGoodsList.length && window.page.promptlyPurchase.call(this, _this.selectGoodsList);
        })
    }
